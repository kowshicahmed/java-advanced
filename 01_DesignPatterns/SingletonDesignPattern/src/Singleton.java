        ...
        if (firstInstance == null) {
            ...
            if (firstThread) {
                ...
                try {
                    ...
                    Thread.sleep(1000); // in multi-threading, the first thread sleeps here
                    // in the meantime the second thread can create an instance, which is a problem
                    // this part was implemented just to mimic that problem
